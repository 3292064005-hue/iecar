...
void ENCODER_1_INIT(void)
{
    ...
    GPIO_PinAFConfig(GPIOA,GPIO_PinSource6,GPIO_AF_TIM3);//PB0Ÿ
    GPIO_PinAFConfig(GPIOA,GPIO_PinSource7,GPIO_AF_TIM3);//PB1ŷ
    ...
    TIM_TimeBaseStructure.TIM_Period = 65535; //һ¼װԶװؼĴڵֵ
    TIM_TimeBaseStructure.TIM_Prescaler = 0; //ΪTIMxʱƵʳԤƵֵ  Ƶ
