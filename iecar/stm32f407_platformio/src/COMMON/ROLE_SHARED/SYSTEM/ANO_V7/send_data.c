...
spl06_data.baro_height = (uint32_t)((102000.0f	- spl06_data.presure) * 78.740f);  //ÿ1mparƽθ߶Ϊ78.740mm
//ݽ //20msһ
...
void gxt_v7_send(u16 v7_id,s32 v7_val)
{
	...
	gxt_data_to_send[gxt_cnt++]=0;//ֽ--·Ѿֵù
...
void UART1_Send_Str(u8 *s,u8 cnt_s)//ַ    Ӧָ 
{
	u8 i;
	for(i=0;i<cnt_s;i++)
	{
...
//Ԫq0,q1,q2,q3Ŵ10000rongheں״̬,10
